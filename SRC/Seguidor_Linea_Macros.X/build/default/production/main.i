...
# 2674 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic16f877a.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic16f877a.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 1877 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\proc\\pic16f877a.inc" 3
...
# 2674 "C:\\Program Files\\Microchip\\xc8\\v2.31\\pic\\include\\pic_as_chip_select.inc" 2 3
...
INISYS:
    ...
    BSF STATUS, 5 ; Banco1
    ; Modificar TRIS
    BSF TRISB, 0 ; PORTB,0 = PortB0 <- entrada
    BSF TRISB, 1 ; PORTB,1 = PortB1 <- entrada
    BSF TRISB, 2 ; PORTB,2 = PortB2 <- entrada
    BCF TRISD, 0 ; PORTD,0 = PortD0 <- salida
    BCF TRISD, 1 ; PORTD,1 = PortD1 <- salida
    BCF TRISD, 2 ; PORTD,2 = PortD2 <- salida
    BCF TRISD, 3 ; PORTD,3 = PortD3 <- salida
    BCF TRISD, 4 ; PORTD,4 = PortD4 <- salida
    BCF TRISD, 5 ; PORTD,5 = PortD5 <- salida
    BCF TRISD, 6 ; PORTD,6 = PortD6 <- salida
    ; Regresar a banco 0
...
AVANCE:
 BTFSC PORTB,0
 GOTO STOP ;SI ES 1
 BTFSS PORTB,1 ;SI ES 0
 GOTO STOP ;SI ES 0
 BTFSC PORTB,2 ;SI ES 1
 GOTO STOP ;SI ES 1
 AVANZAR ;SI ES 0
 GOTO MAIN
 ...
 BTFSS PORTB,0
 GOTO GIZQ ;SI ES 0
 BTFSS PORTB,1 ;SI ES 1
 GOTO GIZQ ;SI ES 0
 BTFSS PORTB,2 ;SI ES 1
 GOTO GIZQ ;SI ES 0
 DETENER ;SI ES 1
 GOTO MAIN
...
GIZQ:
 ...
 BTFSC PORTB,0
 GOTO MAIN ;SI ES 1
 BTFSC PORTB,1 ;SI ES 0
 GOTO MAIN ;SI ES 1
 BTFSC PORTB,2 ;SI ES 0
 GOTO MAIN ;SI ES 1
 RETROCEDER ;SI ES 0
 GOTO MAIN
